...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <span className="text-purple-500 ">Bhumi</span>
        <span className="text-pink-500 ">Rana</span>
      </h3>
      ...
      {/* Resume */}
      <a
        href="/assets/Bhumi.pdf"
        download="Bhumi Rana.pdf"
      ...
      >
        ...
        <p className="my-2 "> bhumi.rana@techstaunch.com </p>
      ...
      <button
        ...
        onClick={() => window.open("mailto:bhumi.rana@techstaunch.com")}
      >
        Email me
      </button>
      <button
